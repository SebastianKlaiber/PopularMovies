...
import de.k11dev.sklaiber.popularmovies.provider.base.BaseContentProvider;
...
public class MovieProvider extends BaseContentProvider {
    ...
    public static final String AUTHORITY = "de.k11dev.sklaiber.popularmovies.provider";
